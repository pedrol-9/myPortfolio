  ...
  return (
    <div>
      <div className='px-4 py-2 mt-4 hover:bg-[#E8DFCA] hover:bg-opacity-10 rounded-lg transition duration-300' id='current-experience'>
        ...
        <h3 className='font-lastnames italic'>{t('homebanking_project')}</h3>
        ...
        <div className='flex flex-wrap md:flex-nowrap md:gap-2 justify-center md:items-center'>
          <picture className='w-10/12 relative block overflow-hidden rounded-lg my-4 shadow-[0px_0px_10px_2px_#2d3748] hover:shadow-[0px_0px_10px_6px_#2d3748] md:w-6/12 lg:w-3/12 xl:w-1/12'>
            ...
            <img src="/homebankingApp.PNG" alt="Homebanking App thumbnail" className='rounded-lg w-full' />
          ...
          <p className='w-full md:px-2 md:line-clamp-6'>{t('homebanking_description')}</p>
        </div>
      </div>
      ...
      <div  className='px-4 py-2 mt-4 hover:bg-[#E8DFCA] hover:bg-opacity-10 rounded-lg transition duration-300' id='past-experience'>
        ...
        <h3 className='font-lastnames italic'>{t('moviestack_project')}</h3>

        <div className='flex flex-wrap md:flex-nowrap md:gap-2 justify-center md:items-center'>
          <picture className='w-10/12 relative block overflow-hidden rounded-lg my-4 shadow-[0px_0px_10px_2px_#2d3748] hover:shadow-[0px_0px_10px_6px_#2d3748] md:w-6/12 lg:w-3/12 xl:w-1/12'>

            <img src="/moviestackApp.PNG" alt="Moviestack App thumbnail" className='rounded-lg w-full' />
          ...
          <p className='w-full md:px-2 md:line-clamp-6'>{t('moviestack_description')}</p>
        </div>
