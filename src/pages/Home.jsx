...
const Home = () => {
  ...
  return (
    <div className='flex flex-col text-white p-6 m-1 mt-24'>
      ...
      <div className='text-justify px-4 py-2 rounded-xl mt-8 '>
        <div className='flex items-baseline'>
          <h1 className='text-2xl font-semibold italic'>{t('transcripts')}</h1>
          <hr className='flex-1 ml-2 border-dotted' />
        </div>
        <Transcripts />
      </div>
      ...
      <div className='text-justify px-4 py-2 rounded-xl mt-8 '>
        <div className='flex items-baseline'>
          <h1 className='text-2xl font-semibold italic'>{t('skills')}</h1>
          <hr className='flex-1 ml-2 border-dotted' />
        </div>
        <Skills />
      </div>
